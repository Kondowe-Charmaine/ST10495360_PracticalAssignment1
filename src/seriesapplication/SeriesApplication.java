...
public class SeriesApplication {
    public static void main(String[] args) {
        ...
        boolean exitProgram = false; // controls the whole program
        ...
        while (!exitProgram) {
            ...
            if (input.hasNextInt() && input.nextInt() == 1) {
                boolean runningMenu = true; // controls the menu loop

                // Menu keeps looping after every action until user exits
                while (runningMenu) {
